...
// All AI test cases are commented out because the Gemini API always returns error 404 and cannot be tested reliably.
...
//       expect(screen.getByText('Personal')).toBeInTheDocument();
//       expect(screen.getByText('Shared')).toBeInTheDocument();
//       expect(screen.getByTestId('personal-task-count')).toHaveTextContent('1');
//       expect(screen.getByTestId('shared-task-count')).toHaveTextContent('1');
//     });
//   });
